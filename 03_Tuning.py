...
def ChangingNodes_Classification():
    ...
    model = data_model.BaseClassificationModel(
...
def Classification_Tuning():
    ...
    ChangingNodes_Classification()
    ChangingBatchSize_Classification()
    ChangingOptimizer_Classification()
    FinalModel_Classification()
